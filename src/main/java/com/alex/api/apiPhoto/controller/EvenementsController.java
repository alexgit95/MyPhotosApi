...
public class EvenementsController {
	...
	public @ResponseBody List<Evenements> getEvenementsByDate(@PathVariable String datedebut,@PathVariable String datefin) throws Base64DecodingException, ParseException {
	...
	public @ResponseBody List<Photos> setNom(@PathVariable String id,@PathVariable String name) throws Base64DecodingException  {
